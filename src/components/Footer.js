        ...
        <footer className="border-t border-slate-200/40 py-10 bg-gradient-to-b from-white via-slate-50 to-white">
            <div className="container mx-auto px-4 sm:px-8 text-center text-slate-500">
                <div className="flex justify-center space-x-6 mb-4">
                    <a href="https://www.instagram.com/saitirumala_concrete" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-orange-500 transition-colors">
                    ...
                    <a href="mailto:saitirumalaconcrete21@gmail.com" aria-label="Email" className="hover:text-orange-500 transition-colors">
